#Install Python neccesary libraries for this Program/Application
...
#pillow library in Python is used for image processing tasks
...
def screenshot():
#defining The Function named 'screenshot'

    time.sleep(5)                          
    #5Secs#whenever we call this function , it should wait for sometime and then take a click;
    
    img = pyautogui.screenshot('test.png');    
    #itll take ss and save it as test.png 
    
    img.show()                              
    #after clicking itll show the pic once
    
    
screenshot()      
#to run the function

#But, Here the problem is, it's again and again updating the 'test.png file' , losing the data of previous pic (overwritten)
...
defining the Function named 'screenshot'
    ...
    #converting random numbers into integers by rounding it and saving it as a variable 'name'
    
    name = 'C:/Users/ayxnk/Desktop/python/screenshots data/{}.png'.format(name) 
    #itll save the pic with the random number generated.png 
...
->now if we want our pic/clicks to be saved in one single folder then,
